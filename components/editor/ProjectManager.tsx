...
import { Download, FilePlus2, HardDriveDownload, Upload } from "lucide-react";
...
export function ProjectManager() {
  ...
  const { newProject, exportProjectJson, importProject, loadLocal } = useEditorStore();
  ...
  return (
    <section className="rounded-xl border border-slate-700 bg-slate-950/70 p-3">
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        <Button variant="ghost" size="sm" onClick={() => loadLocal()}>
